...
public abstract class AbsHeaderView extends RelativeLayout implements IHeader {
    ...
    public <T extends AbsHeaderView> T setStateString(String title) {
        this.mStateString = title;
        return (T) this;
    }

    @SuppressWarnings("unchecked")
    public <T extends AbsHeaderView> T setStateDrawable(Drawable drawable) {
        this.mStateDrawable = drawable;
        return (T) this;
    }

    @SuppressWarnings("unchecked")
    public <T extends AbsHeaderView> T setStateDrawable(int resId){
        if (resId <= 0) {
            return (T) this;
        }
